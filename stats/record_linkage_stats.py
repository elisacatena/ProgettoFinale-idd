...
class recordLinkageStats :
    ...
    def logisticRegressionStats(self) :
        df = pd.to_csv('recordLinkage/record_linkage_country.csv', encoding='latin-1')
        print(df)
        ...
        df_test = pd.to_csv('stats/testStats.csv', encoding='latin-1')
